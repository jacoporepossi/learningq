...
keywords: [python classes, object oriented programming python, python classmethod vs staticmethod, python oop methods self vs cls]
---


## Introduction
In [Part 1](https://jacoporepossi.github.io/learningq/posts/2022-05-28-python-classes-part1/) of this Object-oriented programming tutorial, I explored the basics of Classes in Python, dealing with important concepts such as class variables and instance variables.
